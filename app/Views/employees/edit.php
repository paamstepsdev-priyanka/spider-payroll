                  ...
                  <select name="contractor_id" id="contractor_id" class="form-select <?= session('errors.contractor_id') ? 'is-invalid' : '' ?>">
                    ...
                    <?php foreach ($contractors as $contractor): ?>
                      <option value="<?= $contractor['contractor_id'] ?>" <?= (string)old('contractor_id', $employee['contractor_id']) === (string)$contractor['contractor_id'] ? 'selected' : '' ?>>
                        <?= esc($contractor['contractor_name']) ?> (<?= esc($contractor['contractor_code']) ?>) <?= $contractor['status'] === 'inactive' ? '[Inactive]' : '' ?>
                      </option>
                    <?php endforeach; ?>
                  </select>
            ...
            <div class="step-panel d-none" id="step-panel-3">
              <div class="row">
                ...
                <div class="col-md-3 mb-3">
                  ...
                  <input type="text" name="ifsc_code" id="ifsc_code" class="form-control text-uppercase <?= session('errors.ifsc_code') ? 'is-invalid' : '' ?>" value="<?= old('ifsc_code', $employee['ifsc_code']) ?>" placeholder="e.g. HDFC0001234" maxlength="11">
