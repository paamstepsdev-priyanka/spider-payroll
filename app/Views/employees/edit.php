  ...
  <div class="card-header bg-white p-4 border-bottom d-flex align-items-center justify-content-between flex-wrap gap-3">
    <div class="d-flex align-items-center gap-3">
      ...
      <div>
        ...
        <span class="text-secondary small">Update details for <strong><?= esc($employee['employee_name']) ?></strong></span>
      </div>
    </div>
    ...
    <div class="row g-0">
      ...
      <div class="col-lg-3 border-end bg-light bg-opacity-50 p-4 d-flex flex-column justify-content-between" style="min-height: 540px;">
        <div>
          ...
          <div class="vertical-stepper-list" id="employeeStepperNav">
            ...
            <div class="stepper-step-item" id="step-item-2">
              <div class="stepper-step-line"></div>
              <button type="button" class="stepper-step-button" data-step="2" id="step-tab-2">
            ...
            <div class="stepper-step-item" id="step-item-3">
              <div class="stepper-step-line"></div>
              <button type="button" class="stepper-step-button" data-step="3" id="step-tab-3">
            ...
            <div class="stepper-step-item" id="step-item-4">
              <div class="stepper-step-line"></div>
              <button type="button" class="stepper-step-button" data-step="4" id="step-tab-4">
            ...
            <div class="stepper-step-item" id="step-item-5">
              <div class="stepper-step-line"></div>
              <button type="button" class="stepper-step-button" data-step="5" id="step-tab-5">
        ...
        <div class="mt-4 p-3 rounded-3 bg-white border shadow-sm">
          ...
          <p class="text-secondary mb-2" style="font-size: 11px; line-height: 1.4;">
            If you need help editing employee profiles, contact HR support.
          </p>
      ...
      <div class="col-lg-9 p-4 p-lg-5 d-flex flex-column justify-content-between">
        <div>
          ...
          <!-- EMPLOYEE FORM -->
          <form action="<?= site_url('employees/update/' . $employee['employee_id']) ?>" method="POST" id="employeeForm" autocomplete="off" novalidate>
            <?= csrf_field() ?>
            ...
            <div class="step-panel" id="step-panel-1">
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" name="employee_name" id="employee_name" class="form-control <?= session('errors.employee_name') ? 'is-invalid' : '' ?>" value="<?= old('employee_name', $employee['employee_name']) ?>" placeholder="e.g. Rahul Patil" required>
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" name="phone_number" id="phone_number" class="form-control <?= session('errors.phone_number') ? 'is-invalid' : '' ?>" value="<?= old('phone_number', $employee['phone_number']) ?>" placeholder="e.g. 9876543210">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" name="biometric_code" id="biometric_code" class="form-control <?= session('errors.biometric_code') ? 'is-invalid' : '' ?>" value="<?= old('biometric_code', $employee['biometric_code']) ?>" placeholder="e.g. BIO001">
            ...
            <div class="step-panel d-none" id="step-panel-2">
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <select name="is_direct_employee" id="is_direct_employee" class="form-select <?= session('errors.is_direct_employee') ? 'is-invalid' : '' ?>" required>
                    ...
                    <option value="1" <?= (string)old('is_direct_employee', $employee['is_direct_employee'] ?? '') === '1' ? 'selected' : '' ?>>Yes</option>
                    <option value="0" <?= (string)old('is_direct_employee', $employee['is_direct_employee'] ?? '') === '0' ? 'selected' : '' ?>>No</option>
                  </select>
                ...
                <div class="col-md-6 mb-3 <?= (string)old('is_direct_employee', $employee['is_direct_employee'] ?? '') === '1' ? '' : 'd-none' ?>" id="contractor-id-container">
                  ...
                  <select name="contractor_id" id="contractor_id" class="form-select <?= session('errors.contractor_id') ? 'is-invalid' : '' ?>">
                    ...
                    <?php foreach ($contractors as $contractor): ?>
                      <option value="<?= $contractor['contractor_id'] ?>" <?= (string)old('contractor_id', $employee['contractor_id']) === (string)$contractor['contractor_id'] ? 'selected' : '' ?>>
                        <?= esc($contractor['contractor_name']) ?> <?= $contractor['status'] === 'inactive' ? '[Inactive]' : '' ?>
                      </option>
                    <?php endforeach; ?>
                  </select>
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="date" name="date_of_joining" id="date_of_joining" class="form-control <?= session('errors.date_of_joining') ? 'is-invalid' : '' ?>" value="<?= old('date_of_joining', $employee['date_of_joining']) ?>" required>
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" name="designation" id="designation" class="form-control <?= session('errors.designation') ? 'is-invalid' : '' ?>" value="<?= old('designation', $employee['designation']) ?>" placeholder="e.g. Helper, Supervisor">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" name="department" id="department" class="form-control <?= session('errors.department') ? 'is-invalid' : '' ?>" value="<?= old('department', $employee['department']) ?>" placeholder="e.g. Production, Maintenance">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="number" step="0.01" min="0" name="monthly_base_salary" id="monthly_base_salary" class="form-control <?= session('errors.monthly_base_salary') ? 'is-invalid' : '' ?>" value="<?= old('monthly_base_salary', $employee['monthly_base_salary']) ?>" placeholder="18000.00" required>
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <select name="status" id="status" class="form-select <?= session('errors.status') ? 'is-invalid' : '' ?>" required>
                    ...
                    <option value="relieved" <?= old('status', $employee['status']) === 'relieved' ? 'selected' : '' ?>>Relieved</option>
            ...
            <div class="step-panel d-none" id="step-panel-3">
              <div class="row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" name="account_holder_name" id="account_holder_name" class="form-control <?= session('errors.account_holder_name') ? 'is-invalid' : '' ?>" value="<?= old('account_holder_name', $employee['account_holder_name'] ?? '') ?>" placeholder="Name as per bank records" required>
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" name="bank_account_number" id="bank_account_number" class="form-control <?= session('errors.bank_account_number') ? 'is-invalid' : '' ?>" value="<?= old('bank_account_number', $employee['bank_account_number']) ?>" placeholder="e.g. 001234567890" required>
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" name="ifsc_code" id="ifsc_code" class="form-control text-uppercase <?= session('errors.ifsc_code') ? 'is-invalid' : '' ?>" value="<?= old('ifsc_code', $employee['ifsc_code']) ?>" placeholder="e.g. HDFC0001234" maxlength="11" required>
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" name="bank_name" id="bank_name" class="form-control <?= session('errors.bank_name') ? 'is-invalid' : '' ?>" value="<?= old('bank_name', $employee['bank_name']) ?>" placeholder="Auto-filled or enter manually" required>
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" name="bank_branch" id="bank_branch" class="form-control <?= session('errors.bank_branch') ? 'is-invalid' : '' ?>" value="<?= old('bank_branch', $employee['bank_branch']) ?>" placeholder="Auto-filled or enter manually" required>
            ...
            <div class="step-panel d-none" id="step-panel-4">
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" name="pan_number" id="pan_number" class="form-control text-uppercase <?= session('errors.pan_number') ? 'is-invalid' : '' ?>" value="<?= old('pan_number', $employee['pan_number']) ?>" placeholder="e.g. ABCDE1234F">
            ...
            <div class="step-panel d-none" id="step-panel-5">
              <div class="text-secondary small mb-3">
                <i class="bi bi-info-circle me-1"></i> Please review all information carefully before updating this record.
              </div>
