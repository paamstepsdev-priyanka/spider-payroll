...
<div class="card mb-4" style="background-color: #ffffff !important; border: 1px solid #e5e7eb; border-radius: 6px;">
  <div class="card-header d-flex justify-content-between align-items-center py-3" style="background-color: #ffffff !important; border-bottom: 1px solid #e5e7eb;">
    <div>
      <h4 class="mb-0 fw-semibold text-dark fs-5">Edit Employee</h4>
      <div class="text-secondary small mt-1">Update details for <?= esc($employee['employee_name']) ?></div>
    </div>
  ...
  <div class="card-body p-4" style="background-color: #ffffff !important;">
    ...
    <div class="mb-4">
      <div class="nav nav-pills nav-justified gap-2 border p-2 rounded bg-light" id="employeeStepperNav">
        ...
        <button type="button" class="nav-link text-start d-flex align-items-center gap-2" data-step="2" id="step-tab-2">
        ...
        <button type="button" class="nav-link text-start d-flex align-items-center gap-2" data-step="3" id="step-tab-3">
        ...
        <button type="button" class="nav-link text-start d-flex align-items-center gap-2" data-step="4" id="step-tab-4">
