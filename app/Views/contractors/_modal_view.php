<div class="p-2">
  ...
  <div class="d-flex justify-content-end gap-2 border-top pt-3">
    <a href="<?= site_url('contractors/edit/' . $contractor['contractor_id']) ?>" class="btn btn-primary px-4 fw-medium" style="border-radius: 6px;">
      <i class="bi bi-pencil me-1"></i> Edit Contractor
    </a>
    <button type="button" class="btn btn-outline-secondary px-3" data-bs-dismiss="modal" data-coreui-dismiss="modal" style="border-radius: 6px;">
      Close
    </button>
  </div>
</div>
